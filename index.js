...
const questions = [
  ...
  // GitHub Repository
  {
    ...
    validate: function (answer) {
      if (answer.length < 1) {
        return console.log(
          "You must enter the name of your GitHub repository."
        );
      }
      return true;
    },
  ...
  // Project Installation
  {
    ...
    name: "installation",
    message:
      "Explain how user would install (if necessary) for Installation Section.",
  ...
  // Usage of project
  {
    ...
    name: "usage",
    message:
      "Enter your project instructions and examples of it in use for Usage Section.",
  },
  // Select license
  {
    type: "list",
  ...
  // Test for project
  {
    ...
    name: "tests",
    message:
      "Provide tests for project, and explain how to test (if necessary).",
    // Validation not required if question is optional
  },
];
